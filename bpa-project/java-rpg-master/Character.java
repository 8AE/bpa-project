...
public class Character implements Common {
    ...
    /**
     * A character in the game. This can be the main hero or an NPC. The characters can attack, move, and talk.
     * 
     * @param x the X coordinate on the map
     * @param y the Y coordinate on the map
     * @param id the character number in order from the sprite map. Starts from 0.
     * @param direction the default direction that the character faces.
     * @param moveType the way the character moves. Can either be 0 or 1. 0 means it will not move and 1 means it will move randomly.
     * @param damageable is this character damageable? 0 means no and 1 means yes.
     * @param attackType the character's attack style. 0 = no attack, 1 = random attack, = interval attack.
    ...
    /**
     * Change the health of this Character and then update the percentage of max for health bar use.
    ...
    /**
     * Get the power this Character has. Stat is used in calculating attack damage.
    ...
    /**
     * Set whether or not this Character has been attacked. This is used to display the health bar.
     * Eventually this will automatically return to false if it has been awhile since Character
     * has been last attacked.
     * @param isAttacked boolean value of whether or not the Character has been attacked.
     */
    ...
    /**
     * Get the currently wielded weapon of this Character. Used to calculate the Character's Attack.
    ...
    /**
     * Move the Character and continue to return true that they are moving until the moving is completed.
     * The Character moves progressively, pixel by pixel.
     * Checks if it can move in the set direction before actually moving. If it cannot move, it won't.
    ...
    /**
     * Calculates if the Character can move left. If it can, it does move the Character left.
    ...
    /**
     * Calculates if the Character can move right. If it can, it does move the Character right.
    ...
    /**
     * Calculates if the Character can move up. If it can, it does move the Character up.
    ...
    /**
     * Calculates if the Character can move down. If it can, it does move the Character down.
    ...
    /**
     * Checks if there is a Character in front of the hero and then make them face the hero.
    ...
    /**
     * Change if this Character is moving or not and reset the length it has moved since last change to zero.
    ...
    /**
     * Get the currently set message of this Character. Each Character can have up to 10 preset messages,
     * so the one it is currently set to will return.
     ...
     * @param currentMessage the number 0-9, that indicates which message to display.
     */
    ...
    /**
     * Set the message of this character. Change the specified one by putting a-j in front of it (IN LOWERCASE).
     * The message should be in all caps. If no lowercase letter is put in front of it, then it defaults to message0.
     * Can change multiple messages at once by separating the messages with each lowercase letter.
     * @param message the new message to have the character say. Should be all caps. Can include lowercase a-j to indicate certain message to change.
     */
    ...
    /**
     * Damage this Character by reducing its health by the amount put into the parameter.
     * Updates the percentage of the Character's health remaining.
    ...
    /**
     * Heal this Character by increasing its health by the amount put into the parameter.
     * Updates the percentage of the Character's health remaining.
    ...
    /**
     * Updates the percentage of the Character's health remaining by taking its current health and dividing it
     * by the max health possible.
     */
     ...
     * @return the counter of how long this Character has been consecutively attacking for.
     */
    ...
    /**
     * Increases the attack counter by one to indicate that one game tick has occurred.
     */
